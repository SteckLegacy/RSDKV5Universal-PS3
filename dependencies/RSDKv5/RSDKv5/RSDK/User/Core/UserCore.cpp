...
void RSDK::LoadSettingsINI()
{
    ...
    if (ini) {
        ...
        videoSettings.mirrorScreen   = iniparser_getboolean(ini, "Video:mirrorScreen", false);
        ...
        videoSettings.mirrorScreen   = false;
...
void RSDK::SaveSettingsINI(bool32 writeToFile)
{
    ...
    if (changedVideoSettings || writeToFile) {
        ...
        WriteText(file, "mirrorScreen=%s\n", (videoSettings.mirrorScreen ? "y" : "n"));
        if (ini) {
