...
float RenderDeviceBase::prevViewSizeX    = 0;
float RenderDeviceBase::prevViewSizeY    = 0;
...
{
    if (videoSettings.windowWidth != videoSettingsBackup.windowWidth || videoSettings.windowHeight != videoSettingsBackup.windowHeight
        || videoSettings.windowed != videoSettingsBackup.windowed) {
        videoSettingsBackup.windowWidth  = videoSettings.windowWidth;
        videoSettingsBackup.windowHeight = videoSettings.windowHeight;
        videoSettingsBackup.windowed     = videoSettings.windowed;

        RenderDevice::windowRefreshDelay = 2;
    }
}
