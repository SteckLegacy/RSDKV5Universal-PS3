...
const char *GetModConfigString(const char *section, const char *key, const char *defaultValue);
int32 GetModConfigInteger(const char *section, const char *key, int32 defaultValue);
bool32 GetModConfigBool(const char *section, const char *key, bool32 defaultValue);

const char *FindModFile(const char *filePath);
